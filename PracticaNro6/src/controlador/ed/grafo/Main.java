...
//            ged.etiquetarVertice(5, new Marca(1, "Chamba", true));
//            
//            ged.insertarAristaE(ged.getEtiqueta(1), ged.getEtiqueta(5));
//            ged.insertarAristaE(ged.getEtiqueta(5), ged.getEtiqueta(3));
